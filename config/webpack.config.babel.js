...
<<<<<<< HEAD
  return {
    ...
    entry: [...(target === 'web' && isEnvDevelopment ? ['webpack-hot-middleware/client?reload=true'] : []), `./src/client/main-${target}.js`],
    output: {
      // The build folder.
              ...
              options: {
                ...
                presets: [
                  ...
                  [
                    ...
                    {runtime: hasJsxRuntime ? 'automatic' : 'classic', importSource: '@emotion/react'},
                  ],
                ],
                plugins: [
                  isEnvDevelopment
...
=======
    return {
        ...
        externals:
            target === 'node' ? ['@loadable/component', nodeExternals({
                allowlist: [
                    /\.css$/i,
