export default {
    ...
    react: ['react', 'react-dom', 'react-redux', 'react-tap-event-plugin', 'react-universal-component'], // careful react-redux  and redux-first-router-link can introduce a bug with react-hot-loader
